...
public class DialogueToolWindow : EditorWindow
{
    ...
    Color _nameHeaderColor = new Color(14f/255f, 65f/255f, 30f/255f, 1f);
    Color _portraitHeaderColor = new Color(14f/255f, 65f/255f, 30f/255f, 1f);
    ...
    void InitTextures()
    {
        ...
        _textHeaderTexture.SetPixel(0, 0, _textHeaderColor);
        _textHeaderTexture.Apply();

        _nameHeaderTexture = new Texture2D(1, 1);
        _nameHeaderTexture.SetPixel(0, 0, _nameHeaderColor);
        _nameHeaderTexture.Apply();

        _portraitHeaderTexture = new Texture2D(1,1);
        _portraitHeaderTexture.SetPixel(0, 0, _portraitHeaderColor);
